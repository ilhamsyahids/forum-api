...
describe('ThreadCommentRepositoryPostgres', () => {
  ...
  describe('addComment function', () => {
    it('should return added comment correctly', async () => {
      ...
      const commentRepo = new ThreadCommentRepositoryPostgres(pool, idGenerator);
  ...
  describe('deleteComment function', () => {
    it('should return true when succesfully delete comment', async () => {
      ...
      const isDeleted = await commentRepo.deleteComment('comment-123');
  ...
  describe('verifyCommentOwner function', () => {
    it('should not throw error when comment owner is valid', async () => {
      ...
      await expect(commentRepo.verifyCommentOwner('comment-123', 'user-123')).resolves.not.toThrowError(AuthorizationError);
    });
